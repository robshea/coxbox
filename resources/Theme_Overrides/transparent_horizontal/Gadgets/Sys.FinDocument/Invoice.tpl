...
<form action="" method="post" target="<$Model.SubmitFormTarget$>" id="idMemberInvoiceDetailsForm" class="paymentDetailsForm">
		...
		<div id="idPrimaryContentBlock1Content">
			...
			<div id="topMessageBoxDiv">
				...
				<$if (Model.InvoiceDetails.IsBalanceDue)$>
					<$MessageBox(Text=InvoiceTopMessageBox(), Warning="True", ShowHeader="True", HeaderText=Model.InvoiceDetails.TopMessageBoxHeader, HeaderSpanId="invoiceTopMessageHeaderId")$>
				<$endif$>
			...
			<div class="formContainer">
				<div class="generalFieldsContainer">
					...
					<$FormHelpers (caption="true", name=Model.InvoiceDetails.Text.InvoiceDetailsLabel)$>
					...
					<$FormHelpers (sectionStart="true")$>
									...
									<span>
										...
										<$if (Model.InvoiceDetails.ShowPaymentDocument)$>  
											<$if (Model.InvoiceDetails.IsInvoicePaid)$>
												<$Model.InvoiceDetails.PaymentsDocument:
												{
													<div>
						...
						<$FormHelpers (simpleText="true", name=Model.InvoiceDetails.Text.InvoiceNumberLabel, value=Model.InvoiceDetails.Number)$>

						<$FormHelpers (simpleText="true", name=Model.InvoiceDetails.Text.DateLabel, value=Model.InvoiceDetails.Date)$>

						<div class="fieldContainer simpleTextContainer">
							<div class="fieldSubContainer labeledTextContainer">
								<div class="fieldLabel">
									<span>
										<$Model.InvoiceDetails.Text.InvoiceOriginLabel$>
									</span>
								</div>
						...
						<div class="fieldContainer simpleTextContainer">
							<div class="fieldSubContainer labeledTextContainer">
								<div class="fieldLabel">
									<span>
										<$Model.InvoiceDetails.Text.InvoiceToLabel$>
									</span>
								</div>
						...
						<$if (Model.InvoiceDetails.MemoIsNotEmpty)$>
							<$FormHelpers (simpleText="true", name=Model.InvoiceDetails.Text.MemoLabel, value=Model.InvoiceDetails.Memo)$>
						<$endif$>
