(function (window, WA, undefined)
{
  ...
  function WaContentGadgetResizer(initModel)
  {
    ...
    function setEditableContainerHeight()
    {
      ...
      var gadgetHeight = container.offsetHeight - WA.getElementStyleInt(container, 'paddingBottom', window),
      ...
      editableContainerHeight = editableContainer.offsetHeight - WA.getElementStyleInt(editableContainer, 'paddingTop', window) - WA.getElementStyleInt(editableContainer, 'paddingBottom', window);
