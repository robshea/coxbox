...
/* html: 
   <span
     validatorType="required|email|date|passwordCompare|minLength"
...
jq$.iFormValidate =
  {
    ...
    setValidators: function ($validators)
    {
      ...
      function setValidator ()
      {
        ...
        {
          throw ('Undefined controlToValidate attribute. ValidatorType: ' + jq$(this).attr('validatorType'));
        }

        if (testErrorMessage == null || testErrorMessage == 'undefined' || testErrorMessage.length == 0)
        {
          throw ('Undefined errorMessage attribute. ValidatorType: ' + jq$(this).attr('validatorType'));
        }

        if (alreadySet[id] == null)
        {
          alreadySet[id] = { };
          var $control = jq$('#' + id);
    ...
    validate: function ()
    {
      var $controlToValidate = jq$('#' + $(this).attr('controlToValidate'));
